...
n = 30;   % works for the 3-D case
x1 = 0.22;  % index for generating posotive elements %%0.22--30
x2 = 0.08; % index for generating negative elements %% 0.08--30

Q_pos_rd = Q_neg_generator(n,x1);
...
%legend('log|\sum P - c_1|','log|\sum P  - c_2|','log|\sum P - c_3|')
...
% 1000, 300
for i=1:n
     marginal1 = scatter3(i,0,0,1000.*c_1(i),'filled','LineWidth',1.5,'MarkerEdgeColor','k','MarkerFaceColor',[0 .75 .75]);
end
% 
for i=1:n
     marginal2 = scatter3(0,i,0,1000.*c_2(i),'filled','LineWidth',1.5,'MarkerEdgeColor','k','MarkerFaceColor',[0 .75 .75]);
end
% 
for i=1:n
     marginal3 = scatter3(0,0,i,1000.*c_3(i),'filled','LineWidth',1.5,'MarkerEdgeColor','k','MarkerFaceColor',[0 .75 .75]);
end

% 1.5--30

C = ones(length(I1),1)*[0 0 1];
scatter3sph(I1,J1,K1,'size',1.5.*sqrt(pos_point(list1)),'color',C,'trans',0.6);

C = [1 0 0];
scatter3sph(I2,J2,K2,'size',1.5.*sqrt(abs(neg_point(list2))),'color',C,'trans',0.7);
...
% 1000, 8000
for i=1:n
     marginal1 = scatter3(i,0,0,1000.*q_1(i),'filled','LineWidth',1.5,'MarkerEdgeColor','k','MarkerFaceColor',[0 .75 .75]);
end
% 
for i=1:n
     marginal2 = scatter3(0,i,0,1000.*q_2(i),'filled','LineWidth',1.5,'MarkerEdgeColor','k','MarkerFaceColor',[0 .75 .75]);
end
% 
for i=1:n
     marginal3 = scatter3(0,0,i,1000.*q_3(i),'filled','LineWidth',1.5,'MarkerEdgeColor','k','MarkerFaceColor',[0 .75 .75]);
end

%15/20 -- 30
C = ones(length(I1),1)*[0 0 1];
scatter3sph(I1,J1,K1,'size',15.*sqrt(Qpos_point(list1)),'color',C,'trans',0.5);

C = [1 0 0];
scatter3sph(I2,J2,K2,'size',25.*sqrt(abs(Qneg_point(list2))),'color',C,'trans',0.6);
...
% % 1000, 300
% for i=1:n
% % marginal1 = scatter3(i,0,0,1000.*c_1(i),'filled','MarkerFaceColor',"#7E2F8E");
%      marginal1 = scatter3(i,0,0,1000.*c_1(i),'filled','LineWidth',1.5,'MarkerEdgeColor','k','MarkerFaceColor',[0 .75 .75]);
% end
% % 
% for i=1:n
%      marginal2 = scatter3(0,i,0,100.*c_2(i),'filled','LineWidth',1.5,'MarkerEdgeColor','k','MarkerFaceColor',[0 .75 .75]);
% end
% % 
% for i=1:n
%      marginal3 = scatter3(0,0,i,100.*c_3(i),'filled','LineWidth',1.5,'MarkerEdgeColor','k','MarkerFaceColor',[0 .75 .75]);
% end
% 
% 
% for i=1:length(I1)
%      pt_neg = scatter3(I1(i),J1(i),K1(i),300*pos_point(I1(i),J1(i),K1(i)),'filled','MarkerFaceColor','r');
% end
% 
% for i=1:length(I2)
%      pt_neg = scatter3(I2(i),J2(i),K2(i),300*abs(neg_point(I2(i),J2(i),K2(i))),'filled','MarkerFaceColor','b');
% end
% 
% 
% hold off
% 
% xlabel('c_1','FontSize',16)
% ylabel('c_2','FontSize',16)
% zlabel('c_3','FontSize',16)
% axis tight
% grid on
% xticks([1:n])
% yticks([1:n])
...
% 
% for i=1:length(I1)
%      pt_neg = scatter3(I1(i),J1(i),K1(i),30000*Qpos_point(I1(i),J1(i),K1(i)),'filled','MarkerFaceColor','r');
% end
% 
% for i=1:length(I2)
%      pt_neg = scatter3(I2(i),J2(i),K2(i),50000*abs(Qneg_point(I2(i),J2(i),K2(i))),'filled','MarkerFaceColor','b');
% end
% 
% 
% hold off
% 
% % xlabel('q_1','FontSize',16)
% % ylabel('q_2','FontSize',16)
% % zlabel('q_3','FontSize',16)
% axis tight
% grid on
% xticks([1:n])
% yticks([1:n])
