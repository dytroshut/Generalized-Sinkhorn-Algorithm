...
angc = linspace((1/2+1/8)*pi,(3/2-1/8)*pi,n1);
xc = 0.5;
yc = 0;
rc = 2;
cx = xc+rc * cos(angc);
...
angm = linspace((1/2-1/8)*pi,(-1/2+1/8)*pi,n2);
xm = -0.5;
ym = 0;
rm = 2;
mx = xm+rm * cos(angm);
...
plot(coord1,coord2,'Color',[0, 0, 1, 0.2],'LineWidth',0.01)
end
...
hm = text(mx.*1.05, my.*1.05, mrna, 'FontSize',8);
