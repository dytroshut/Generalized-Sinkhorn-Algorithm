...
angc = linspace(0,2*pi-0.01,n1);
rc = 1;
cx = rc * cos(angc);
cy = rc * sin(angc);

angm = linspace(0,2*pi-0.01,n2);
rm = 0.5;
mx = rm * cos(angm);
my = rm * sin(angm);
...
plot(coord1,coord2,'Color',[0, 0, 1, 0.1],'LineWidth',0.01)
end
...
plot(coord1,coord2,'Color',[1, 0, 0, 0.1],'LineWidth',0.01,'LineStyle','--')
end
